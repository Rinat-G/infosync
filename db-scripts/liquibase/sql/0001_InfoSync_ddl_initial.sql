...
(
    ...
    "RECOMMENDED_BY_ID" BIGINT  NOT NULL,
    CONSTRAINT "POST_PK" PRIMARY KEY ("ID"),
    CONSTRAINT "POST_GROUP_ID_FK" FOREIGN KEY ("GROUP_ID") REFERENCES "GROUP" ("ID"),
    CONSTRAINT "POST_RECOMMENDED_BY_ID_FK" FOREIGN KEY ("RECOMMENDED_BY_ID") REFERENCES "USER" ("ID") ON DELETE SET NULL
);
...
(
    ...
    "MARK"       INT    NOT NULL,
    "MARK_BY_ID" BIGINT NOT NULL,
    CONSTRAINT "RATING_PK" PRIMARY KEY ("ID"),
    CONSTRAINT "RATING_ESSAY_ID_FK" FOREIGN KEY ("ESSAY_ID") REFERENCES "ESSAY" ("ID") ON DELETE CASCADE,
    CONSTRAINT "RATING_MARK_BY_ID_FK" FOREIGN KEY ("MARK_BY_ID") REFERENCES "USER" ("ID") ON DELETE SET NULL,
    CONSTRAINT "RATING_ESSAY_MARK_BY_U" UNIQUE ("ESSAY_ID", "MARK_BY_ID")
);
